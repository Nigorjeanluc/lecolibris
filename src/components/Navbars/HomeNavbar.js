      ...
      <nav className="top-0 fixed z-50 w-full flex flex-wrap items-center justify-between px-2 py-3 navbar-expand-lg bg-white shadow">
        <div className="container px-4 mx-auto flex flex-wrap items-center justify-between">
          <div className="w-full relative flex justify-between lg:w-auto lg:static lg:block lg:justify-start">
            ...
            >
              <img style={{width: 90, height: 75}} alt="..." src={logo} />
            </Link> */}
            <button
            ...
            <ul className="flex flex-col lg:flex-row list-none mr-auto">
              <li className="flex items-center">
                <a
                  ...
                  href="/"
                >
                  <i className="text-gray-500 fa fa-home text-lg leading-lg mr-2" />{" "}
                  Accueil
                </a>
              </li>
              <li className="flex items-center">
                <a
                  ...
                  href="#"
                >
                  <i className="text-gray-500 fa fa-graduation-cap text-lg leading-lg mr-2" />{" "}
                  Notre école
                </a>
              </li>
              <li className="flex items-center">
              ...
              <li className="flex items-center">
                <a
                  ...
                  href="#"
                >
                  <i className="text-gray-500 fa fa-child text-lg leading-lg mr-2" />{" "}
                  Vie scolaire
                </a>
              </li>
              <li className="flex items-center">
                <a
                  ...
                  href="#"
                >
                  <i className="text-gray-500 fa fa-id-card  text-lg leading-lg mr-2" />{" "}
                  Inscription
                </a>
              </li>
            </ul>
